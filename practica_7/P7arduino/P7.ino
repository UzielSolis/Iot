...
#define TOKEN "BBUS-dFovFXfyR0FL7giEohTNGtl4LtAwp2" // Put your Ubidots' TOKEN
#define MQTT_CLIENT_NAME "MQTTool-3943576052" // MQTT client Name, please enter your own 8-12 alphanumeric character ASCII string; 
...
#define DEVICE_LABEL "MQTT-publish-ESP32" // Assig the device label
