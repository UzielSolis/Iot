...
public class MainActivity extends Activity {
    ...
    public class ApiUbidots extends AsyncTask<Integer, ProgressUpdate, Void> {
        private final String API_KEY_UBIDOTS = "BBUS-dFovFXfyR0FL7giEohTNGtl4LtAwp2";
        private final String TempVariable_ID = "65ea70cf63050c000d0be871";
        private final String HumVariable_ID = "65ea7101958f8c000e23bf99";
